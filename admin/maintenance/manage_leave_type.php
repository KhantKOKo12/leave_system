...
<div class="container-fluid">
	<form action="" id="leave_type-form">
		...
		<div class="form-group">
			...
			<textarea name="description" id="description" cols="30" rows="3" style="resize:none !important" class="form-control form no-resize " required><?php echo isset($description) ? $description : ''; ?></textarea>
		</div>
		<div class="form-group">
			<label for="default_credit" class="control-label">Default Credits</label>
			<input name="default_credit" id="default_credit" step="any" type="number" class="form-control form text-right " value="<?php echo isset($default_credit) ? $default_credit : ''; ?>" required/>
		</div>
		<div class="form-group">
