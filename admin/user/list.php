...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title" style="padding-top:5px;">List of System Users</h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn" style="background: #4A9B82;border-radius: 6px;color: #FFFFFF;"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
