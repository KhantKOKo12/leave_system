            ...
            <div class="col-2" style="padding-top: 30px;">
                <div class="w-100">
                    <div class="form-group d-flex justify-content-between align-middle">
                        <button class="btn" style="background: #4A9B82;border-radius: 6px;color: #FFFFFF;" type="button" id="filter"><i class="fa fa-filter"></i> Filter</button>
                        <button class="btn btn-flat btn-success" style="border-radius: 6px;" type="button" id="print"><i class="fa fa-print"></i> Print</button>
                    </div>
                </div>
            </div>
        </div>
