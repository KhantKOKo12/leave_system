...
<div class="card card-outline card-primary">
				...
				<div class="row">
					<div class="col-6">
						...
						<div class="form-group">
							...
							<textarea rows="3" name="address" id="address" class="form-control" style="resize:none !important" required><?php echo isset($meta['address']) ? $meta['address']: '' ?></textarea>
						</div>
					</div>
					<div class="col-6">
						<div class="form-group">
							<label for="department_id">Department</label>
							<select name="department_id" id="department_id" class="form-control select2bs4 select2" data-placeholder="Please Select Department here" reqiured>
	...
	<div style="padding-left:27px;padding-bottom:27px;">
			<div class="col-md-12">
				<div class="row">
					<button class="btn mr-3" style="background:#4A9B82;width:100px;color:#fff;" form="manage-user">Save</button>
					<a class="btn" style="border:1px solid #4A9B82;border-radius:6px;width:100px;" href="./?page=employees">Cancel</a>
				</div>
			</div>
		</div>
</div>
