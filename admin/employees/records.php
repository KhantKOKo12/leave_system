...
<div class="card">
    <div class="card-body">
        <div class="w-100 d-flex justify-content-end mb-3">
            ...
            <a href="?page=employees/manage_employee&id=<?php echo $id ?>" class="btn" style="background: #4A9B82;border-radius: 6px;color: #FFFFFF;"><span class="fas fa-edit"></span>  Edit Employee</a>
            <?php endif; ?>
            <a href="javascript:void(0)" class="btn btn-success ml-3" style="border-radius:6px;" id="print"><span class="fas fa-print"></span>  Print</a>
        </div>
        <div id="print_out">
